...
serve(async (req) => {
  ...
  try {
    console.log('📧 Send Task Assigned email started');
...
<head>
  ...
  <title>Neuer Auftrag verfügbar</title>
</head>
<body style="margin: 0; padding: 0; background-color: #f5f5f7; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, sans-serif;">
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f5f5f7;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="background-color: #ffffff; padding: 32px 40px; text-align: center; border-bottom: 1px solid #e5e7eb;">
              ...
              <p style="margin: 0; color: #6b7280; font-size: 14px; font-weight: 500;">Neuer Auftrag</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 0 40px 40px 40px;">
              ...
              <p style="margin: 0 0 24px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                Ihnen wurde ein neuer Auftrag zugewiesen. Absolvieren Sie diesen, um die Vergütung zu erhalten.
              </p>
              ...
              <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 20px; margin-bottom: 24px;">
                ...
                <div style="display: flex; align-items: center; gap: 8px;">
                  <span style="color: #64748b; font-size: 14px;">Vergütung:</span>
                  <span style="color: #10b981; font-size: 20px; font-weight: 700;">${formattedCompensation}</span>
                </div>
              </div>
    ...
    const { data: emailResult, error: emailError } = await resend.emails.send({
      ...
      subject: `Neuer Auftrag: ${payload.task_title} - ${brandingName}`,
      html: htmlEmail,
    });
    ...
    console.log('✅ Task assigned email sent successfully:', emailResult);
    ...
    console.error('💥 Error in send-task-assigned:', error);
    return new Response(
